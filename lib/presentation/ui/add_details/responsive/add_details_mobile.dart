...
class AddDetailsMobile extends StatefulWidget {
  final AddDetails data;
  const AddDetailsMobile({super.key, required this.data});

  @override
  State<AddDetailsMobile> createState() => _AddDetailsMobileState();
}

class _AddDetailsMobileState extends State<AddDetailsMobile> {
            ...
            return Dialog.fullscreen(
              child: BackButtonListener(
                ...
                child: VideoPreviewPage(
                  previewData: widget.data.videoFile,
                ),
              ),
            );
          }),
