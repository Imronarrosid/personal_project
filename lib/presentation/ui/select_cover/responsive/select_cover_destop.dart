...
// class SelectCoverDesktop extends StatefulWidget {
//   const SelectCoverDesktop({super.key, required this.file});

//   final XFile file;

//   @override
//   State<SelectCoverDesktop> createState() => _SelectCoverDesktopState();
// }

// class _SelectCoverDesktopState extends State<SelectCoverDesktop> {
...
//                                     valueListenable:
//                                         _controller.selectedCoverNotifier,
//                                     builder: (context, value, child) {
//                                       if (value == null ||
//                                           value.thumbData == null) {
//                                         return Container(
...
//                                         );
//                                       }
//                                       return Image.memory(value.thumbData!);
//                                     },
//                                   ),
//                                 ),
//                                 Container(
...
// class CoverListner extends ValueNotifier<XFile?> {
//   CoverListner(super.value);

//   selectCover(Uint8List data) {
//     value = XFile.fromData(data);
//     notifyListeners();
//   }
// }
